...
[Mesh]
  file = MP_ss_griffin_out_bison0_cp/LATEST
[]

[Problem]
  restart_file_base = MP_ss_griffin_out_bison0_cp/LATEST
  force_restart = true
[]
...
[BCs]
  [outside_bc]
    ...
    T_infinity = 800 # K air temperature at the top of the core 300
  []
  [hp_temp]
    type = MatchedValueBC
...
[UserObjects]
  [flux_uo]
    ...
    num_layers = 100
    variable = temp
    diffusivity = ${fparse 0.15/normal_factor} #0.15
    execute_on = linear
    boundary = 'hp_graphite_in hp_reflector_in'
  []
[]
...
[Postprocessors]
  [hp_heat_integral]
    ...
    variable = temp
    boundary = 'hp_graphite_in hp_reflector_in'
	diffusivity = ${fparse 0.15/normal_factor} #0.15 #TC of SS
	execute_on = 'initial timestep_end'
  []
