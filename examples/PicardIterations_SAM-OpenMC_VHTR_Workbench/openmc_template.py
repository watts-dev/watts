...
def build_openmc_model(params):
    ...
    homfuel1 = openmc.Material(name="homfuel_1", temperature=params['avg_Tf_1'])
    ...
    homfuel2 = openmc.Material(name="homfuel_2", temperature=params['avg_Tf_2'])
    ...
    homfuel3 = openmc.Material(name="homfuel_1", temperature=params['avg_Tf_3'])
    ...
    homfuel4 = openmc.Material(name="homfuel_1", temperature=params['avg_Tf_4'])
    ...
    homfuel5 = openmc.Material(name="homfuel_1", temperature=params['avg_Tf_5'])
